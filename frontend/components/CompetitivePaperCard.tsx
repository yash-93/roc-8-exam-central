...
const CompetitivePaperCard = ({ paper, isDraft, isBookmark, allBookmarkedPapers, setAllBookmarkedPapers, customStyles }: PropTypes) => {
...
export default CompetitivePaperCard;
